...
{
    BMS_ONBOARD_TEMPS_t onboard_temps = {};
    Unpack_BMS_ONBOARD_TEMPS_hytech(&onboard_temps, &msg.buf[0], msg.len);
    _curr_data.max_board_temp = HYTECH_max_board_temp_ro_fromS(onboard_temps.max_board_temp_ro);
    _curr_data.min_cell_temp = HYTECH_low_cell_temp_ro_fromS(onboard_temps.low_cell_temp_ro);
    _curr_data.max_cell_temp = HYTECH_high_cell_temp_ro_fromS(onboard_temps.high_cell_temp_ro);
