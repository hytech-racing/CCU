...
void DisplayInterface::display_data() {
    ...
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().max_cell_voltage, 3);

   
    Display.print("Cell Voltage min: ");
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().min_cell_voltage, 3);
 

    Display.print("Cell Voltage avg: ");
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().average_voltage, 3);


    Display.print("Cell Voltage delta: ");
    Display.println((ACUInterfaceInstance_t::instance().get_latest_data().max_cell_voltage - ACUInterfaceInstance_t::instance().get_latest_data().min_cell_voltage), 3);


    Display.print("Total pack Volts: ");
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().total_voltage, 3);


    Display.print("Max Board Temp (C): ");
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().max_board_temp, 3);

    
    Display.print("Max Cell Temp (C): ");
    //Display.println(_ccu_data.max_cell_temp, 3); 
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().max_cell_temp, 3);


    Display.print("Min Cell Temp (C): ");
    Display.println(ACUInterfaceInstance_t::instance().get_latest_data().min_cell_temp, 3);

    Display.print("Avg Cell Temp (C): ");
    Display.println((ACUInterfaceInstance_t::instance().get_latest_data().max_cell_temp + ACUInterfaceInstance_t::instance().get_latest_data().min_cell_temp)/2, 3);
