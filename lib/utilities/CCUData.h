...
struct CCUData
{
  ...
  static constexpr float cutoff_voltage = 4.16; //max voltage that cells can be at - if high = this, stop charging
  static constexpr float charger_current_max = 200; //120 = 3.4 amps
